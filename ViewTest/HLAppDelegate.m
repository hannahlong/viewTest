...
//  ViewTest
//
//  Created by Hannah Long on 9/9/14.
//  Copyright (c) 2014 Hannah Long. All rights reserved.
//

#import "HLSimpleView.h"
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    HLSimpleView* view1 = [[HLSimpleView alloc] initWithFrame: frame1];
    view1.backgroundColor = [UIColor whiteColor];
    [self.window addSubview:view1];
    
    //create another view
    CGRect frame2 = CGRectMake(20, 20, 50, 50);
    HLSimpleView* view2 = [[HLSimpleView alloc] initWithFrame: frame2];
